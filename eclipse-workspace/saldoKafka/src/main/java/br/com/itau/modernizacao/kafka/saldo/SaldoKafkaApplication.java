...
public class SaldoKafkaApplication {

	public static void main(String[] args) {
		SpringApplication.run(SaldoKafkaApplication.class, args);
	}
	...
	public io.opentracing.Tracer tracer() {
        ...
        return new Configuration("SaldoKafka").withSampler(samplerConfig).withReporter(reporterConfig).getTracer();
